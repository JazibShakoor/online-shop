...
const Checkout = (props) => {
  ...
  const confirmHandler = (event) => {
    ...
    const enteredContactNumberIsValid = !isEmpty(enteredContactNumber);
  ...
  const contactNumberControlClasses = `${classes.control} 
    ${formInputsValidity.contactNumber ? "" : classes.invalid}`;
  ...
  return (
    <form className={classes.form} onSubmit={confirmHandler}>
      ...
      <div className={contactNumberControlClasses}>
        ...
        <input type="text" id="contactNumber" ref={contactNumberInputRef} />
        {!formInputsValidity.contactNumber && (
